...
const Toast = ({ toast, onClose }) => {
  ...
  }[type] || 'bg-neutral-50 border-neutral-200';

  return (
    <div
      className={`${bgColorClass} border rounded-lg shadow-lg p-4 max-w-sm w-full pointer-events-auto animate-slide-in-right`}
    >
